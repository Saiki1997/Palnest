...
public static class Mods
{
    ...
    [
        new() { Id = "nx-palschema", Name = "Pal Schema", Author = "Okaetsu", Kind = ModKind.PalSchema, Source = ModSource.Nexus, SourceId = "1018", Url = "https://www.nexusmods.com/palworld/mods/1018", Description = "JSON-driven Palworld data packs. Pair with UE4SS.", Downloads = 180000, Version = "0.4", Files = [new() { Name = "PalSchema-0.4.zip", Size = "1.8 MB", Kind = ModKind.PalSchema }] },
        new() { Id = "nx-mapunlock", Name = "Map Revealer", Author = "community", Kind = ModKind.Pak, Source = ModSource.Nexus, SourceId = "524", Url = "https://www.nexusmods.com/palworld/mods/524", Description = "Unlocks the world map.", Downloads = 220000, Version = "1.2", Files = [new() { Name = "MapRevealer_P.pak", Size = "420 KB", Kind = ModKind.Pak }, new() { Name = "MapRevealer-ue4ss.zip", Size = "88 KB", Kind = ModKind.Ue4ss }] },
        new() { Id = "st-breed", Name = "Breed Tweaks", Author = "Workshop", Kind = ModKind.Ue4ss, Source = ModSource.Steam, SourceId = "3456789", Url = "https://steamcommunity.com/sharedfiles/filedetails/?id=3456789", Description = "UE4SS Lua breeding helpers.", Downloads = 41000, Version = "workshop", Files = [new() { Name = "BreedTweaks/Scripts/main.lua", Size = "24 KB", Kind = ModKind.Ue4ss }] },
        new() { Id = "cf-perf", Name = "Performance Pak", Author = "CurseForge", Kind = ModKind.Pak, Source = ModSource.Curseforge, SourceId = "perf", Url = "https://www.curseforge.com/", Description = "LOD and draw-distance pak for dedicated hosts.", Downloads = 9000, Version = "1.0", Files = [new() { Name = "Perf_P.pak", Size = "1.1 MB", Kind = ModKind.Pak }] },
        new() { Id = "nx-admin", Name = "Server Admin", Author = "community", Kind = ModKind.Ue4ss, Source = ModSource.Nexus, SourceId = "2011", Url = "https://www.nexusmods.com/palworld/mods/2011", Description = "In-game admin slash commands.", Downloads = 64000, Version = "2.1", Files = [new() { Name = "ServerAdmin/Scripts/main.lua", Size = "36 KB", Kind = ModKind.Ue4ss }] },
        new() { Id = "nx-death", Name = "Death Cache", Author = "community", Kind = ModKind.Ue4ss, Source = ModSource.Nexus, SourceId = "880", Url = "https://www.nexusmods.com/palworld/mods/880", Description = "Recoverable cache on death.", Downloads = 33000, Version = "1.4", Files = [new() { Name = "DeathCache/Scripts/main.lua", Size = "18 KB", Kind = ModKind.Ue4ss }] },
        new() { Id = "nx-palanalyzer", Name = "Pal Analyzer", Author = "Inhumanick", Kind = ModKind.Ue4ss, Source = ModSource.Nexus, SourceId = "524b", Url = "https://www.nexusmods.com/palworld/mods/312", Description = "Inspect pal stats in the field.", Downloads = 91000, Version = "2.4", Files = [new() { Name = "PalAnalyzer.zip", Size = "210 KB", Kind = ModKind.Ue4ss }] },
        new() { Id = "st-qos", Name = "QoL Pack", Author = "Workshop", Kind = ModKind.Pak, Source = ModSource.Steam, SourceId = "3120001", Url = "https://steamcommunity.com/sharedfiles/filedetails/?id=3120001", Description = "UI and inventory quality of life.", Downloads = 120000, Version = "workshop", Files = [new() { Name = "QoL_P.pak", Size = "2.4 MB", Kind = ModKind.Pak }] },
    ];
}
