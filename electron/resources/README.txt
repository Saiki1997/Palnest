Palnest 2.3.0 — Palworld Server & Mod Manager
=============================================

Two Windows packages ship with this release:

1) Installer — Palnest-Setup-2.3.0.exe
...
2) Portable — Palnest-2.3.0-windows.zip
...
First launch
  ...
  (Steam / CurseForge / Nexus Mods), clone or delete worlds, and watch
  the box from this window.
